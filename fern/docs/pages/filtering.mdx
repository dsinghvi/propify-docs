...
One example of filtering is finding all residents associated with a lease (by the Propify lease ID). This can be done by filtering on the `lease_id` property.
