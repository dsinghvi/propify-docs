...
**Propify is the easiest way to integrate in Proptech**
</Callout>

<br />

Welcome to the Propify documentation! Here you'll find information to get started as well as our API Reference.
...
<Cards>
  <Card
    title="How Propify Works"
    icon="fa-solid fa-head-side-brain"
    href="https://getpropify.com/how-it-works"
  />
  <Card
    title="API Reference"
...
<Cards>
  <Card
    ...
    href="https://getpropify.com/blog"
  />
  <Card
    title="Security"
    icon="fa-solid fa-shield-halved"
    href="https://trust.getpropify.com/"
  />
</Cards>
...
2. Email us at [support@getpropify.com](mailto:support@getpropify.com) and we'll do our best to reply within 48 hours.